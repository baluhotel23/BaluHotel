...
useEffect(() => {
  ...
  if (storedData) {
    try {
      ...
      setTimeout(() => {
        ...
        console.log('🧹 [THANKYOU] Datos de reserva limpiados del localStorage');
      ...
      <>
        ...
        <div className="min-h-screen flex flex-col items-center justify-center bg-gradient-to-br from-gray-50 to-gray-100 py-12">
          <div className="max-w-md w-full bg-white shadow-xl rounded-2xl p-8 text-center">
            ...
            <h2 className="text-xl font-semibold text-gray-700 mb-2">Cargando datos de reserva...</h2>
  ...
  const { bookingDetails, paymentDetails, guestInfo, priceBreakdown } = reservationData;
      ...
      <div className="min-h-screen bg-gradient-to-br from-blue-50 to-indigo-100 py-12 px-4">
        <div className="max-w-4xl mx-auto">
          ...
          <div className="text-center mb-8">
            ...
            <h1 className="text-4xl font-bold text-gray-800 mb-2">¡Reserva Confirmada!</h1>
            <p className="text-xl text-gray-600">Tu reserva ha sido procesada exitosamente</p>
            <p className="text-lg text-blue-600 font-semibold mt-2">
              ID de Reserva: <span className="font-mono">{reservationData.bookingId}</span>
            </p>
          </div>
          ...
          <div ref={pdfRef} className="bg-white rounded-2xl shadow-xl overflow-hidden">
            ...
            <div className="bg-gradient-to-r from-blue-600 to-blue-800 text-white p-8">
              <div className="flex justify-between items-center">
                ...
                <div className="text-right">
                  <p className="text-lg font-semibold">ID: {reservationData.bookingId}</p>
            ...
            <div className="p-8">
                ...
                <div className="bg-gray-50 rounded-xl p-6">
                  <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                    <div>
                      ...
                      <p className="text-lg font-semibold text-gray-800">{guestInfo.scostumername}</p>
                    </div>
                    <div>
                    ...
                    <div>
                      ...
                      <p className="text-lg font-semibold text-gray-800">{guestInfo.selectronicmail}</p>
                    </div>
                    <div>
                      <p className="text-sm font-medium text-gray-600">Teléfono</p>
                      <p className="text-lg font-semibold text-gray-800">{guestInfo.stelephone}</p>
                    </div>
                  </div>
                </div>
              </div>
              ...
              <div className="mb-8">
                ...
                <div className="bg-blue-50 rounded-xl p-6">
                  <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                    <div>
                      <p className="text-sm font-medium text-gray-600">Habitación</p>
                      <p className="text-lg font-semibold text-gray-800">
                        {bookingDetails.roomType} - #{bookingDetails.roomNumber}
                      </p>
                      <p className="text-sm text-gray-600 mt-1">{bookingDetails.roomDescription}</p>
                    </div>
                    <div>
                      ...
                      <p className="text-sm text-gray-600">Total: {bookingDetails.guestCount} personas</p>
                    </div>
                    <div>
                      <p className="text-sm font-medium text-gray-600">Check-in</p>
                      <p className="text-lg font-semibold text-gray-800">{bookingDetails.checkInFormatted}</p>
                    </div>
                    <div>
                      <p className="text-sm font-medium text-gray-600">Check-out</p>
                      <p className="text-lg font-semibold text-gray-800">{bookingDetails.checkOutFormatted}</p>
                    </div>
                    <div>
                      <p className="text-sm font-medium text-gray-600">Noches</p>
                      <p className="text-lg font-semibold text-gray-800">{bookingDetails.nights} noches</p>
                    </div>
                    <div>
                  ...
                  <div className="bg-green-50 rounded-xl p-6">
                    <div className="space-y-3">
                      <div className="flex justify-between">
                        <span className="text-gray-600">Precio base por noche:</span>
                      ...
                      <div className="flex justify-between">
                        ...
                        <span className="font-semibold">{priceBreakdown.guestCount}</span>
                      </div>
                      {priceBreakdown.extraGuestCharges > 0 && (
                        <div className="flex justify-between">
                          <span className="text-gray-600">Cargo por huéspedes extra:</span>
                          <span className="font-semibold">${priceBreakdown.extraGuestCharges?.toLocaleString()}</span>
                        </div>
                      )}
                ...
                <div className="bg-yellow-50 rounded-xl p-6">
                  <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                    <div>
                      ...
                      <p className="text-xl font-bold text-green-600">${paymentDetails.amountPaid?.toLocaleString()}</p>
                    </div>
                    <div>
                      <p className="text-sm font-medium text-gray-600">Método de Pago</p>
                      <p className="text-lg font-semibold text-gray-800 capitalize">{paymentDetails.paymentMethod}</p>
                    </div>
                    <div>
                      <p className="text-sm font-medium text-gray-600">ID de Transacción</p>
                      <p className="text-sm font-mono text-gray-800">{paymentDetails.transactionId}</p>
                    </div>
                    <div>
                      <p className="text-sm font-medium text-gray-600">Referencia</p>
                      <p className="text-sm font-mono text-gray-800">{paymentDetails.paymentReference}</p>
                    </div>
                    {paymentDetails.remainingAmount > 0 && (
                      <div className="md:col-span-2">
                        <div className="bg-orange-100 border border-orange-300 rounded-lg p-4">
                          <p className="text-sm font-medium text-orange-800">Saldo Pendiente</p>
              ...
              <div className="bg-gray-100 rounded-xl p-6">
                <h4 className="text-lg font-bold text-gray-800 mb-3">📋 Información Importante</h4>
                <ul className="space-y-2 text-sm text-gray-600">
                  <li>• Por favor, presente este comprobante al momento del check-in</li>
                  <li>• Check-in disponible a partir de las 3:00 PM</li>
                  <li>• Check-out antes de las 12:00 PM</li>
                  <li>• Para cancelaciones, consulte nuestras políticas</li>
                  <li>• Cualquier consulta, contáctenos al: +57 (xxx) xxx-xxxx</li>
                </ul>
              </div>
            </div>
          </div>
